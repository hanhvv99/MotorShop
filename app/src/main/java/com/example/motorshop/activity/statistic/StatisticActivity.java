...
import com.example.motorshop.activity.guarantee.GuaranteeChitietActivity;
...
public class StatisticActivity extends AppCompatActivity {
    ...
    public void loadPhuTungDK(String tgTu, String tgDen) throws Exception {
    ...
    private void xe() {
        ...
        Toast.makeText(StatisticActivity.this, "Xe", Toast.LENGTH_SHORT).show();
    }

    private void phutung() {
        loadDataPT();
        Toast.makeText(StatisticActivity.this, "PT", Toast.LENGTH_SHORT).show();
    }
            ...
            public void onClick(View v) {
                ...
                if(tgTu.length()>0&&tgDen.length()>0) {
                    if(ktThoiGian(tgTu,tgDen)==true){
                        ...
                        Toast.makeText(StatisticActivity.this, "Thoi gian khong hop le", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    loadDataPT();
                }
    ...
    public void loadDataPT(){
        data = db.loadPTtheoTG();

        load(data);

        int tongSL = db.getAllSLpt();
        TextViewTongSLbanduoc.setText(String.valueOf(tongSL));

        int tongDT = db.getAllDTpt();
